...
export default function HomePage() {
  return (
    <div id="home">
      ...
      <p>
        Next News is here to deliver you all the latest news - concice &
        unbiased!
      </p>
      ...
      <p>
        We employ a team of dedicated journalists who are commited to delivering
        the news in a fair and unbiased manner. Our team is passionate about
        keeping you informmed and up to date with the latest news.
      </p>
